...
public class Proswpikes_Trexoumenes_Yp extends javax.swing.JFrame {
    ...
    int  mousepX,mousepY;
    public Proswpikes_Trexoumenes_Yp() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 430, -1, 40));
        ...
        Lista_Pelatwn.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Αριθμός Πρωτοκόλλου", "Όνομα Πελάτη", "Κατάσταση Timer", "Εργατοώρες"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proswpikes_Trexoumenes_Yp().setVisible(true);
            }
        });
    }

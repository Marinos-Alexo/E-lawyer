...
public class Diathesimes_Formes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Στοιχεία Πελάτη");
        ...
        Lista_Pelatwn.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ημερομηνία Καταχώρησης", "Δίκαιο"
            }
        ));
        Lista_Pelatwn.setSelectionBackground(new java.awt.Color(255, 255, 153));
        jScrollPane1.setViewportView(Lista_Pelatwn);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 480, 190));
